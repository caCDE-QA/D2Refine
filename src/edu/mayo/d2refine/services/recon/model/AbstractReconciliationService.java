...
import edu.mayo.d2refine.services.model.IF.D2RefineServiceType;
import edu.mayo.d2refine.services.recon.model.IF.ReconciliationServiceIF;

public abstract class AbstractReconciliationService implements ReconciliationServiceIF
{
        final static Logger logger = LoggerFactory.getLogger("AbstractReconciliationService");
        
        protected String name;
        protected String id;
        protected D2RefineServiceType serviceType;
        ...
        public void setServiceType(D2RefineServiceType serviceType) 
        {
